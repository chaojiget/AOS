...
项目维护者负责解释与执行行为准则，并采取适当行动回应任何不可接受的行为。
...
维护者有权利与义务删除、编辑或拒绝违背本准则的评论、提交、代码、wiki 编辑、issue 或其他贡献。
...
若你遭遇或目击不当行为，请通过邮件 `aos-maintainers@example.com` 联系维护团队。
...
若行为被认为不恰当但影响较轻，维护者将发布非公开或公开的警告，并澄清期待的行为标准。
...
若行为持续或严重，维护者可能发布正式警告，并要求停止违规行为。
