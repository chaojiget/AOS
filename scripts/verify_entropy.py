...
def main():
    ...
    # Scenario A: All good
    logs_good = [
        LogEntry(level="INFO", message="OK", logger_name="test") for _ in range(10)
    ]
    ...
    # Scenario B: Panic
    logs_panic = [
        LogEntry(level="ERROR", message="Fail", logger_name="test") for _ in range(8)
    ]
    logs_panic += [
        LogEntry(level="INFO", message="OK", logger_name="test") for _ in range(2)
    ]
